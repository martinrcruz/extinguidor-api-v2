...
SELECT 'Empresa ABC S.L.', 'contacto@empresaabc.com', 'B12345678', 'Calle Mayor 123, Madrid', '+34911234567', 'Roberto Fernández', 'CLI001', true,
    ...
    'Cliente corporativo con múltiples instalaciones', 'Gestor 1', 'foto.jpg', '2025-01-15', '2025-12-31', 'F', 120, 'Madrid', 'T', 'T', 5, 'Normal', 15000.00, NOW(), NOW()
...
SELECT 'Comercial XYZ S.A.', 'info@comercialxyz.com', 'A87654321', 'Avenida Diagonal 456, Barcelona', '+34932123456', 'Laura Torres', 'CLI002', true,
    ...
    'Cliente con sistema de extintores', 'Gestor 2', 'foto.jpg', '2025-03-01', '2025-12-31', 'E', 90, 'Barcelona', 'S', 'S', 3, 'Normal', 8500.00, NOW(), NOW()
...
SELECT 'Industrias DEF S.L.', 'contacto@industriasdef.com', 'B11223344', 'Polígono Industrial Norte, Valencia', '+34961234567', 'Miguel Ángel Ruiz', 'CLI003', true,
    ...
    'Cliente industrial con mantenimiento mensual', 'Gestor 1', 'foto.jpg', '2025-02-10', '2025-12-31', 'R', 180, 'Valencia', 'T', 'T', 8, 'Normal', 22000.00, NOW(), NOW()
...
SELECT 'Centro Comercial Plaza', 'admin@ccplaza.com', 'A55667788', 'Calle Comercio 789, Sevilla', '+34954123456', 'Carmen Jiménez', 'CLI004', true,
    ...
    'Centro comercial con sistema completo', 'Gestor 3', 'foto.jpg', '2025-01-20', '2025-12-31', 'C', 240, 'Sevilla', 'A', 'A', 12, 'Normal', 35000.00, NOW(), NOW()
...
SELECT 'Oficinas Global S.A.', 'info@oficinasglobal.com', 'A99887766', 'Paseo de la Castellana 321, Madrid', '+34911234568', 'David Moreno', 'CLI005', true,
    (SELECT id FROM zones WHERE code = 'MAD-CENTRO' LIMIT 1),
    'Edificio de oficinas corporativas', 'Gestor 1', 'foto.jpg', '2025-04-01', '2025-12-31', 'F', 150, 'Madrid', 'T', 'T', 6, 'Normal', 18000.00, NOW(), NOW()
WHERE EXISTS (SELECT 1 FROM zones WHERE code = 'MAD-CENTRO')
UNION ALL
SELECT 'Hotel Residencia', 'recepcion@hotelresidencia.com', 'B44556677', 'Avenida del Mar 654, Bilbao', '+34944123456', 'Patricia Vega', 'CLI006', true,
    ...
    'Hotel con sistema de seguridad', 'Gestor 2', 'foto.jpg', '2025-03-15', '2025-12-31', 'E', 200, 'Bilbao', 'S', 'S', 10, 'Normal', 28000.00, NOW(), NOW()
...
FROM routes r
CROSS JOIN users u
WHERE (r.date = '2025-12-01' AND u.code IN ('WORKER001', 'WORKER002'))
   OR (r.date = '2025-12-02' AND u.code IN ('WORKER002', 'WORKER003'))
   OR (r.date = '2025-12-03' AND u.code IN ('WORKER003', 'WORKER004'))
   OR (r.date = '2025-12-04' AND u.code IN ('WORKER004', 'WORKER005'))
   OR (r.date = '2025-12-05' AND u.code IN ('WORKER001', 'WORKER005'));
...
WHERE (r.date = '2025-12-01' AND m.code IN ('MAT001', 'MAT002', 'MAT003'))
   OR (r.date = '2025-12-02' AND m.code IN ('MAT001', 'MAT004'))
   OR (r.date = '2025-12-03' AND m.code IN ('MAT002', 'MAT005'))
   OR (r.date = '2025-12-04' AND m.code IN ('MAT001', 'MAT003', 'MAT007'))
   OR (r.date = '2025-12-05' AND m.code IN ('MAT001', 'MAT008'));
...
SELECT 
    ...
    (SELECT id FROM routes WHERE date = '2025-12-01' LIMIT 1),
    (SELECT id FROM users WHERE code = 'WORKER001' LIMIT 1),
    NULL, NOW(), NOW()
...
SELECT 
    ...
    (SELECT id FROM routes WHERE date = '2025-12-02' LIMIT 1),
    (SELECT id FROM users WHERE code = 'WORKER002' LIMIT 1),
    NULL, NOW(), NOW()
...
SELECT 
    ...
    (SELECT id FROM routes WHERE date = '2025-12-03' LIMIT 1),
    (SELECT id FROM users WHERE code = 'WORKER003' LIMIT 1),
    NOW(), NOW(), NOW()
...
SELECT 
    ...
    (SELECT id FROM routes WHERE date = '2025-12-04' LIMIT 1),
    NULL,
    NULL, NOW(), NOW()
...
SELECT 
    ...
    (SELECT id FROM routes WHERE date = '2025-12-05' LIMIT 1),
    NULL,
    NULL, NOW(), NOW()
...
FROM partes p WHERE p.title = 'Mantenimiento Extintores - Empresa ABC' AND p.date = '2025-12-01'
UNION ALL
SELECT p.id, 'Materiales entregados, iniciando instalación', NOW(), (SELECT id FROM users WHERE code = 'WORKER002' LIMIT 1)
FROM partes p WHERE p.title = 'Instalación Sistema Detección - Comercial XYZ' AND p.date = '2025-12-02'
UNION ALL
SELECT p.id, 'Extintor reparado y recargado correctamente', NOW(), (SELECT id FROM users WHERE code = 'WORKER003' LIMIT 1)
FROM partes p WHERE p.title = 'Reparation Extintor - Industrias DEF' AND p.date = '2025-12-03'
UNION ALL
SELECT p.id, 'Revisión en curso, todo funcionando correctamente', NOW(), (SELECT id FROM users WHERE code = 'WORKER001' LIMIT 1)
FROM partes p WHERE p.title = 'Mantenimiento Periódico - Oficinas Global' AND p.date = '2025-12-05';
...
FROM partes p WHERE p.title = 'Instalación CCTV - Hotel Residencia' AND p.date = '2025-12-06'
UNION ALL
...
SELECT 450.00,
    (SELECT id FROM routes WHERE date = '2025-12-01' LIMIT 1),
    (SELECT id FROM partes WHERE title = 'Mantenimiento Extintores - Empresa ABC' AND date = '2025-12-01' LIMIT 1),
    NOW(), NOW()
WHERE EXISTS (SELECT 1 FROM partes WHERE title = 'Mantenimiento Extintores - Empresa ABC')
UNION ALL
SELECT 2500.00,
    (SELECT id FROM routes WHERE date = '2025-12-02' LIMIT 1),
    (SELECT id FROM partes WHERE title = 'Instalación Sistema Detección - Comercial XYZ' AND date = '2025-12-02' LIMIT 1),
    NOW(), NOW()
WHERE EXISTS (SELECT 1 FROM partes WHERE title = 'Instalación Sistema Detección - Comercial XYZ')
UNION ALL
SELECT 180.00,
    (SELECT id FROM routes WHERE date = '2025-12-03' LIMIT 1),
    (SELECT id FROM partes WHERE title = 'Reparation Extintor - Industrias DEF' AND date = '2025-12-03' LIMIT 1),
    NOW(), NOW()
WHERE EXISTS (SELECT 1 FROM partes WHERE title = 'Reparation Extintor - Industrias DEF')
UNION ALL
SELECT 650.00,
    (SELECT id FROM routes WHERE date = '2025-12-01' LIMIT 1),
    (SELECT id FROM partes WHERE title = 'Mantenimiento Periódico - Oficinas Global' AND date = '2025-12-05' LIMIT 1),
    NOW(), NOW()
WHERE EXISTS (SELECT 1 FROM partes WHERE title = 'Mantenimiento Periódico - Oficinas Global')
UNION ALL
SELECT 3200.00,
    (SELECT id FROM routes WHERE date = '2025-12-05' LIMIT 1),
    (SELECT id FROM partes WHERE title = 'Instalación CCTV - Hotel Residencia' AND date = '2025-12-06' LIMIT 1),
    NOW(), NOW()
